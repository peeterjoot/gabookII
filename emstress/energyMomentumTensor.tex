...
\end{equation}
%
This quantity can only have vector, trivector, and five vector grades.Â  The
...
\end{equation}
%
Both of these will get temporarily messy, so let us do them in parts.Â  Starting
with
%
